          ...
          <div class="visitor">
            <div class="visitor_left">
              ...
              <el-form-item :label="t('性别')" prop="visitorSex">
                ...
                <el-select v-model="rule_form.visitorSex" class="location_select" disabled style="width: 175px">
            ...
            <div class="visitor_right">
              <el-form-item :label="t('通行照片')" prop="visitorFacePicture">
                <SingleImage v-model:imageUrl="list_picture" :fileSize="3" disabled @update:image-url="handle_update">
