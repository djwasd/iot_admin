  ...
  <div class="person">
    ...
    <div class="table-wrapper">
      ...
      >
        ...
        <el-table-column :label="t('访客')+t('名称')" prop="id"/>
        <el-table-column :label="t('手机号')" prop="id"/>
        <el-table-column :label="t('车牌号')" prop="id"/>
        <el-table-column :label="t('来访事由')" prop="id"/>
        <el-table-column :label="t('来访时间')" prop="id"/>
        <el-table-column :label="t('抓拍照片')" prop="id"/>
