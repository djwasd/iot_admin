  ...
  <div class="person">
    ...
    <div class="person_echarts">
      <div class="left-box">
        ...
        <mEcharts :height="state_left.height" :options="state_left.options" :width="state_left.width"
                  style="margin-top: -20px"></mEcharts>
      ...
      <div class="right-box">
        ...
        <mEcharts :height="state_right.height" :options="state_right.options" :width="state_right.width"
                  style="margin-top: -20px"></mEcharts>
        <div class="date_packer">
          <el-date-picker
