  ...
  <div>
    ...
    >
      ...
      <el-form
          ...
          :rules="rules"
      >
        <el-form-item class="form_item" :label="t('旧密码')" prop="oldPassword" >
          <el-input   show-password  :placeholder="t('请输入密码') " v-model="register_params.oldPassword"></el-input>
        </el-form-item>
        <el-form-item class="form_item" :label="t('新密码')" prop="password" >
          <el-input   show-password  :placeholder="t('请输入密码') " v-model="register_params.password"></el-input>
        </el-form-item>
        <el-form-item class="form_item" :label="t('确认密码')" prop="confirm_pwd" >
