    ...
    <div class="left">
      ...
      <div class="tree">
        <div v-for="(item,index ) in group_data.records"
             :key="item.id"
        >
          <div class="tree_box" :class="show_item !== index?'tree_box':'tree_box_bg'"  @click="handleNodeClick(item,index)">
          ...
          <div class="tree_content" v-for="(v, index) in device_data"  v-if="show_item === index" :class="{ 'fade-in': show_item === index }">
