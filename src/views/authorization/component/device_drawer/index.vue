      ...
      <template #default>
        ...
        <div class="function">
          <div class="function_left">
            <el-button type="primary" @click="handle_add_device">{{ t('添加设备') }}</el-button>
        ...
        <div class="table-wrapper">
          ...
          >
            ...
            <el-table-column :label="t('操作')" fixed="right" width="100">
              <template #default="{row}">
...
import {handle_del_device} from "@/api/authorization";
