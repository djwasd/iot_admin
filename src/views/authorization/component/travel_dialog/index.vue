    ...
    >
      ...
      >
        ...
        <el-form-item v-if="travel_form.type===2" :label="t('选择时间')" class="form_item">
          <time_table :edit_data="edit_time_data" :traverStatus="traver_status"
                      @save_time="handle_time_save"></time_table>
        </el-form-item>
...
import {formatTimes, timeToTimestamp, transformTimeStamps} from "@/utils/packagingmethod/time";
